import { Pencil, Sparkles, Calendar, List, Plus } from "lucide-react"
      ...
      <div className="flex flex-col gap-5 h-full flex-1">
        ...
        <div className="flex flex-col h-[320px] rounded-xl bg-[var(--card)] border border-[var(--border)] shadow-[0_1px_1.75px_rgba(0,0,0,0.05)] overflow-hidden">
          ...
          <div className="flex items-center justify-between gap-3 px-5 py-4 w-full">
            ...
            <span className="text-[11px] text-[#7C9070]">Auto-saved</span>
          </div>
          ...
          <div className="flex flex-col h-full p-5 border-t-2 border-transparent">
            <div className="flex flex-col gap-1.5 h-full w-full border border-transparent">
              ...
              <div className="flex flex-col gap-2 h-full px-4 py-2 rounded-[var(--radius-m)] bg-white border border-[var(--input)]">
                <textarea
                  className="w-full h-full resize-none text-sm text-[#2D2D2D] bg-transparent border-none outline-none"
                  placeholder="Write your notes here..."
                  defaultValue="System changes implemented in smart home helps my 3-bedroom apartment getting 2x better!"
                />
              </div>
            </div>
          </div>
